        ...
        <div class="row w-100 shadow-lg rounded-4 overflow-hidden" style="max-width: 900px;">
          ...
          <!-- Password Input -->
                    <div class="mb-3 w-100 position-relative">
                        ...
                        <span class="position-absolute toggle-password" style="right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer;" data-target="password">
                            👁️
                        </span>
                    </div>
                    ...
                    <div class="mb-3 w-100 position-relative">
                        ...
                        <span class="position-absolute toggle-password" style="right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer;" data-target="confirm_password">
                            👁️
                        </span>
                    </div>
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            document.querySelectorAll('.toggle-password').forEach(function (eyeIcon) {
                                eyeIcon.addEventListener('click', function () {
                                    ...
                                    // Toggle eye icon (change between open and closed eye icons)
                                    this.textContent = inputType === 'password' ? '👁️' : '🙈';
                                });
                            });
                        });
                    </script>
