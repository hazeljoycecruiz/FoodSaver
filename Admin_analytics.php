...
<body>
  ...
  <div class="container py-4">
    ...
    <div class=" justify-content-center mb-4" style="border: 2px solid #E95F5D; border-radius: 10px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
    ...
    <div class="dashboard" style="width: 10000px; max-width: 100%; margin: auto; background-color: #ffe6e2;">
