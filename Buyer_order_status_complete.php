...
<body>
  ...
  <div class="container-box" style="background-color: #FFD09B;">
    <div class="tabs">
      <div class="tab" onclick="window.location.href='buyer_order_status.php'" style="color: black;">On Shipping</div>
      <div class="tab" onclick="window.location.href='buyer_order_status_cancel.php'" style="color: black;">Cancelled</div>
  ...
  <div class="container-box order-card">
    ...
    <div class="address-line">
      ...
      <span>&rarr;</span>
      <span><strong>Transaction ID: </strong>#8631</span>
    </div>
    ...
    <div class="order-footer">
      ...
      <button class="details-btn" onclick="window.location.href='buyer_order_update_complete.php'">Details</button>
    </div>
  </div>
