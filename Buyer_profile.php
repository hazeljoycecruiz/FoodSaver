        ...
        <div class="row g-3 mt-1 ">
            ...
            <div class="col-md-4" >
                ...
                <div class="profile-picture-container">
                    ...
                    <a href="Buyer_profile.html" class="pb-4 name" style="text-decoration: none;"><h5>Hau C.</h5></a>
                    <!-- Favorites Menu Item -->
            ...
            <div class="col-md-8">
                ...
                <div class="favorites-container" style="border: 2px solid #E95F5D; border-radius: 12px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);">
                        ...
                        <div class="d-flex justify-content-end pt-1">
                            <button type="button" class="btn btn-primary  w-25 rounded-pill" onclick="window.location.href='Buyer_index.html'">Save</button>
                        </div>
