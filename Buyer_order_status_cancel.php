...
<body>
  ...
  <div class="container-box" style="background-color: #FFD09B;">
    <div class="tabs">
      ...
      <div class="tab" onclick="window.location.href='buyer_order_status_complete.php'" style="color: black;">Complete</div>
    </div>
  </div>
  ...
  <div class="container-box order-card">
    ...
    <div class="order-footer">
      ...
      <button class="details-btn" onclick="window.location.href='buyer_cart.php'">Buy Again</button>
    </div>
  </div>
